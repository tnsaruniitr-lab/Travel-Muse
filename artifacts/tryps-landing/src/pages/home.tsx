                ...
                <div>
                  ...
                  <div className="flex items-center gap-3 mt-4">
                    <div className="flex -space-x-3">
                      {["#D97706","#F59E0B","#4ECDC4","#8B5CF6","#EC4899"].map((c, i) => (
                        <div key={i} className="h-10 w-10 rounded-full border-2 border-[#FFFBF0] flex items-center justify-center text-xs font-black text-white" style={{ background: c }}>
                          {String.fromCharCode(65 + i)}
                        </div>
                      ))}
                    </div>
                    <p className="text-sm text-[#6B5230]">Join <strong className="text-[#1C1208]">500+ groups</strong> already planning trips together</p>
                  </div>
                </div>
              </div>
          ...
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            ...
            <ul className="space-y-4 mb-10 list-none p-0">
              {[
                ...
                <li key={row.tool} className="bg-white rounded-2xl px-7 py-5 border border-[#F5D78E]/40 flex items-start gap-4 shadow-sm">
            ...
            <div className="space-y-3">
              {[
                ...
                >
                  ...
                  <p className="text-[#6B5230] leading-relaxed pb-5">{faq.a}</p>
                </details>
              ))}
            </div>
          </div>
